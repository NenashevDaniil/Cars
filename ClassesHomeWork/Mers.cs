...
{
    internal class Mers:Car 
    {
        public Mers(string name, int maxSpeed, string coast, double averageConsumption, double fuelValue) : base ( name, maxSpeed, coast, averageConsumption, fuelValue)
        {
